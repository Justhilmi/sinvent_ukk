...
return new class extends Migration
{
    ...
    {
        DB::statement("
            CREATE TRIGGER stok_masuk_insert AFTER INSERT ON barangmasuk
            FOR EACH ROW
            BEGIN
                UPDATE barang
        ...
        ");
        DB::statement("
            CREATE TRIGGER stok_masuk_delete BEFORE DELETE ON barangmasuk
            FOR EACH ROW
            BEGIN
                UPDATE barang
        ...
        ");
        DB::statement("
            CREATE TRIGGER stok_masuk_update AFTER UPDATE ON barangmasuk
            FOR EACH ROW
            BEGIN
                UPDATE barang
        ...
        ");
        DB::statement("
            CREATE TRIGGER stok_keluar_insert AFTER INSERT ON barangkeluar
            FOR EACH ROW
            BEGIN
                UPDATE barang
        ...
        ");
        DB::statement("
            CREATE TRIGGER stok_keluar_update AFTER UPDATE ON barangkeluar
            FOR EACH ROW
            BEGIN
                UPDATE barang
        ...
        ");
        DB::statement("
            CREATE TRIGGER stok_keluar_delete BEFORE DELETE ON barangkeluar
            FOR EACH ROW
            BEGIN
                UPDATE barang
